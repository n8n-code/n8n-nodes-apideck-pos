...
export const locationsDescription: INodeProperties[] = [
			...
			"options": [
				...
				},
				{
					...
					"routing": {
						"request": {
							"method": "DELETE",
							"url": "=/pos/locations/{{$parameter[\"id\"]}}"
						}
					}
				},
				{
		...
		{
			"displayName": "POST /pos/locations",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "DELETE /pos/locations/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "GET /pos/locations/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "PATCH /pos/locations/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
