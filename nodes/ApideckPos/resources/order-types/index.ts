...
export const orderTypesDescription: INodeProperties[] = [
		{
			...
			"options": [
				{
					"name": "Order Types All",
					"value": "Order Types All",
					"action": "List Order Types",
				...
				{
					"name": "Order Types Add",
					"value": "Order Types Add",
					"action": "Create Order Type",
				...
				{
					"name": "Order Types Delete",
					"value": "Order Types Delete",
					"action": "Delete Order Type",
					"description": "Delete Order Type",
					"routing": {
						"request": {
							"method": "DELETE",
							"url": "=/pos/order-types/{{$parameter[\"id\"]}}"
						}
					}
				},
				{
					"name": "Order Types One",
					"value": "Order Types One",
					"action": "Get Order Type",
				...
				},
				{
					...
					"value": "Order Types Update",
					"action": "Update Order Type",
		...
		{
			"displayName": "GET /pos/order-types",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /pos/order-types",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "DELETE /pos/order-types/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "GET /pos/order-types/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "PATCH /pos/order-types/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
